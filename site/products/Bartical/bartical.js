...
const translations = {
  ...
  en: {
    ...
    navComingAria: 'Open the original Coming Soon item',
    ...
    comingTitle: 'Bartical is coming soon.',
    comingBody: 'Please wait a little longer for distribution to begin.',
    themeLabel: 'Theme',
    themeSystem: 'System',
    themeLight: 'Light',
    themeDark: 'Dark'
